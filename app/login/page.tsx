...
/**
 * Frosted-glass card treatment shared by the public-water panel and
 * the sign-in card so the two read as one composed column over the
 * hero rather than two unrelated boxes.
 */
const glassCard: React.CSSProperties = {
  backgroundColor: "color-mix(in oklab, var(--color-bg-base) 78%, transparent)",
              ...
              {PUBLIC_WATER_SYSTEMS.map((system) => (
                ...
                >
                  <a
                    ...
                    className="group flex items-center justify-between gap-3 rounded-md px-2 py-2.5 transition-colors hover:bg-(--color-bg-surface-raised) focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--color-accent)"
                  >
